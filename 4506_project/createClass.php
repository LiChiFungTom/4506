           ...
           var classs="";
            ...
            $(document).on('click', '#save', function() {
                if(classs==""){
                    ...
                    alert("Class created!");
                    var url = "addStudent.php?class=" + classs + "&teaName=YeeKwanCheng";
            ...
            $(document).on('click', '#edit', function() {
                ...
                var url="editClass.php?class="+Class+"&teaName=YeeKwanCheng";
                window.location.href = url;
            });
        ...
        <ul>
            ...
            <li>
                <a href="teaSeacrchAt.html">
                    <span class="icon"><ion-icon name="list-outline"></ion-icon></span>
                    <span class="title">Search Student's Attendance</span>
                </a>
            </li>
