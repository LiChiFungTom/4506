    ...
    <script type="text/javascript">
       $(document).ready(function(){  
            ...
            $(document).on("click","#course", function(e){
                ...
                var studentID=row.find("td:eq(0)").html();
                var Class=row.find("td:eq(1)").html();
                var stuName=row.find("td:eq(2)").html();
                var phone=row.find("td:eq(3)").html();
                var url = "teaViewEditStu.php?studentID="+studentID+"&class="+Class+"&stuName="+stuName+"&phone="+phone;
    ...
    <div class="main">
        ...
        <table>
            ...
            <tbody id="myTable">
                ...
                <?php
                    if(isset($_GET["studentID"]) && isset($_GET["stuName"])){
                        $form= <<<EOF
                        <tr id="course">
                        <td>%s</td>
                            <td>%s</td>
                        ...
                        EOF;
                        printf($form,$_GET["studentID"],$_GET["class"],$_GET["stuName"],$_GET["phone"]);
                    }
                    else{
                ?>
